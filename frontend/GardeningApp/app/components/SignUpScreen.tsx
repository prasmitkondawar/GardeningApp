...
import { View, TextInput, Button, Text, StyleSheet, Alert, KeyboardAvoidingView, Platform, TouchableOpacity, ActivityIndicator } from 'react-native';
...
export default function SignUpScreen () {
  ...
  async function handleSignUp() {
    ...
    if (error) {
      ...
      Alert.alert('Success!', 'Check your email for OTP password.');
      router.push({
    ...
    <KeyboardAvoidingView
        ...
        >
          <View style={styles.box}>
            ...
            <Text style={styles.subtitle}>Enter your email to start gardening!</Text>
            <TextInput
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.8}
            >
              <Text style={styles.secondaryButtonText}>Already have an account? <Text style={styles.linkText}>Login</Text></Text>
            </TouchableOpacity>
          </View>
        </KeyboardAvoidingView>
      );
